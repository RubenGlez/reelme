...
**Project page:** [rubenglez.dev/reelme](https://rubenglez.dev/reelme)
...
| [reelme](https://github.com/RubenGlez/reelme) | playful · intro | [GIF](./gallery/reelme/reelme.gif) |
...
Set `project.look` to pick the art direction — lighting, camera, color grade, and cut rhythm: `keynote`, `noir`, `arcade`, `blueprint`, or `editorial`. It defaults from your `tone`, so it's optional.
